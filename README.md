...
99% что нет. Qualcomm-сторона роутера это совершенно иная архитектура, под которую нет нужных исходников, а в частности драйверов для работы с железом. Кастомная модификация стока — возможно, полценный OpenWRT — вряд ли. 
