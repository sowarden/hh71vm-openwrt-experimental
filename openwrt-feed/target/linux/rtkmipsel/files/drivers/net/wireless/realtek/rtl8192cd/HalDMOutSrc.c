...
)
{
	...
	if ((priv->up_time % 3) == 0)  {
		...
		int disable_pwr_ctrl = ((ODMPTR->false_alm_cnt.cnt_all > 1000) || ((ODMPTR->false_alm_cnt.cnt_all > 300) && (IGI >= 0x32))) ? 1 : 0;
...
#if defined(CONFIG_WLAN_HAL_8192EE) || defined(CONFIG_WLAN_HAL_8822BE) || defined(CONFIG_WLAN_HAL_8198F) || defined(CONFIG_WLAN_HAL_8814BE) || defined(CONFIG_WLAN_HAL_8197G)
		if ((GET_CHIP_VER(priv) == VERSION_8192E)||(GET_CHIP_VER(priv) == VERSION_8822B)||(GET_CHIP_VER(priv) == VERSION_8198F)||(GET_CHIP_VER(priv) == VERSION_8814B)||(GET_CHIP_VER(priv) == VERSION_8197G)) {
