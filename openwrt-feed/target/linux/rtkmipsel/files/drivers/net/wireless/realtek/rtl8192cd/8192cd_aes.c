			 ...
			 const unsigned char *addr[], const int *len, unsigned char *mac)
{
	...
	unsigned char cbc[AES_BLOCK_SIZE] __attribute__((aligned(4)));
	unsigned char pad[AES_BLOCK_SIZE] __attribute__((aligned(4)));
